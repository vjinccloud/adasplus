...
$sql = "select rowid,username,account,isenable from user_list  ";
...
<body class="crm_body_bg">
    ...
    <section class="main_content dashboard_part large_header_bg">
                        ...
                        <div class="page_title_box d-flex align-items-center justify-content-between">
                            ...
                            <div class="add_button ms-2">
                                <!-- <a href="#" class="btn btn-primary"
                                    data-bs-toggle="modal" data-bs-target="#search_modal"><i
                                        class=" ti-search f_s_14 me-2"></i>搜尋</a> -->
                                <a href="account_management_dataCreate.php"
                                    class="btn btn-success">建立</a>
                            </div>
                        </div>
                    </div>
                </div>
                                    ...
                                    <table id="mytable" class="table lms_table_active3">
                                        ...
                                        <tbody>
                                            ...
                                            while ($stmt = $result->fetch(PDO::FETCH_ASSOC)) {
                                                ...
                                                $isenablestr = intval($stmt['isenable']) == 1 ? "啟用" : "停用";




                                            ?>
                                                <tr class="dataRow" rowid="1">
                                                    <th scope="row"><?php echo $account ?></th>
                                                    <td><?php echo $username ?></td>
                                                    <td>
                                                        <i class="far fa-circle f_s_14 text_color_3"></i> <?php echo $isenablestr ?>
                                                    </td>
                                                    <td>
                                                        <div class="action_btns d-flex">
                                                            <a href="account_management_dataEdit.php?id=<?php echo $rowid ?>" class="action_btn mr_10"> <i class="far fa-edit"></i></a>
                                                            <a href="#" class="action_btn" onclick="delconfim(<?php echo $rowid ?>)"> <i class="fas fa-trash"></i></a>
                                                        </div>
                                                    </td>
                                                </tr>
                                            <?php } ?>
                                    ...
                                    <nav aria-label="Page navigation example">
                                        <!-- <ul class="pagination justify-content-end">
                                            <li class="page-item disabled"><a class="page-link"
                                                    href="//team.vjinc.biz/member/website_customer/?page=1"
                                                    tabindex="-1" aria-disabled="true">Previous</a></li>
                                            <li class="page-item active"><a class="page-link"
                                                    href="//team.vjinc.biz/member/website_customer/?page=1">1</a></li>
                                            <li class="page-item "><a class="page-link"
                                                    href="//team.vjinc.biz/member/website_customer/?page=2">2</a></li>
                                            <li class="page-item "><a class="page-link"
                                                    href="//team.vjinc.biz/member/website_customer/?page=2">Next</a>
                                            </li>
                                        </ul> -->
                                    </nav>
                                </div>
        ...
        <div class="modal fade show" id="search_modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-modal="true" style="display: none;">
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    <form role="form" name="search" action="//team.vjinc.biz/member/website_customer/search.html" method="post" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        <div class="common_input mb_15">
                                            <input type="text" placeholder="姓名" name="csName" value="">
                                        </div>
                                    </div>
                                    <div class="col-lg-6">
                                        <div class="common_input mb_15">
                                            <input type="text" placeholder="手機" name="csMobile" value="">
                                        </div>
                                    </div>
                                    <div class="col-lg-6">
                                        <div class="common_input mb_15">
                                            <input type="text" placeholder="電子信箱" name="csEmail" value="">
                                        </div>
                                    </div>
                                    <div class="col-lg-12">
                                        <div class="row">
                                            <div class="col-lg-6">
                                                ...
                                                <label class="form-label form-check-label" for="enable">帳號可用</label>
                                            </div>
                                            <div class="col-lg-6">
                                                <input type="checkbox" class="form-check-input" id="disable" name="disable" value="1">
                                                <label class="form-label form-check-label" for="disable">帳號不可用</label>
                                            </div>
                                        </div>
                                    </div>
