...
$sql = "select rowid,username,account,isenable from user_list where rowid=:id  ";

$result = $pdo->prepare($sql);
$result->execute(['id' => $rowid]);
...
<body class="crm_body_bg">
              ...
              <div class="page_title_left">
                <ol class="breadcrumb page_bradcam mb-0">
                  <li class="breadcrumb-item">
                    <a href="javascript:void(0);">帳號管理</a>
                  </li>
                </ol>
              </div>
            </div>
              ...
              <div class="white_card_body">
                <div class="card-body">
                  <form
                    role="form"
                    name="dateEdit"
                    action="//team.vjinc.biz/member/website_customer/dataSave.html"
                    method="post"
                    enctype="multipart/form-data">
                    <div class="row">
                      <div class="col-lg-6 mb-3">
                        <div class="col-md-12 mb_15">
                          <label class="form-label" for="zh_TW_Name">帳號</label>
                          <input
                            type="text"
                            class="form-control"
                            name="zh_TW_Name"
                        ...
                        <div class="col-md-12 mb_15">
                          <label class="form-label" for="email">使用者名稱</label>
                          <input
                            type="text"
                            class="form-control"
                            name="nick_name"
                        ...
                        <div class="col-md-12 mb_15">
                          <label class="form-label" for="csId">帳號狀態</label>
                    ...
                    <div class="devices_btn justify-content-end">
                      <div class="">
                        ...
                        <button
                          ...
                          onclick="delconfim(<?php echo $rowid ?>)">
                          刪除
                        </button>
                        <button
                          type="button"
  ...
  <script type="text/javascript">
    ...
    async function saveData() {
      ...
      form_data.append("id",<?php echo $rowid ?>);
