...
<body class="crm_body_bg">
    ...
    <nav class="sidebar">
        <div class="logo d-flex justify-content-between">
            <a class="large_logo" href="https://team.vjinc.biz/member/index.html"><img
                    src="./img/logo.png" alt=""></a>
            <a class="small_logo" href="https://team.vjinc.biz/member/index.html"><img
        ...
        <div class="main_content_iner overly_inner ">
            <div class="container-fluid p-0 ">
                    ...
                    <div class="col-12">
                        <div class="page_title_box d-flex align-items-center justify-content-between">
                            ...
                            <div class="add_button ms-2">
                                <a href="banner2_management_dataCreate.php"
                                    class="btn btn-success editbtns">Create</a>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="row">
                    ...
                    $sql = "select rowid,banner from banner_list  order by b_sort ";
                            ...
                            <div class="white_card position-relative mb_20 ">
                                <div class="card-body">
                                    ...
                                    <div style="max-height: 100px;">
                                        <img src="./<?php echo $imgsrc; ?>" alt="" class="d-block mx-auto my-4"
                                            style="max-width: 98%;max-height:130px">
                                    </div>
                                    <div class="row my-4">
                                        <div class="col"></div>
                                    </div>
                                    <div class="d-grid">
                                        ...
                                        <button class="btn_2 editBtn editbtns" onclick="location.href = 'banner2_management_dataEdit.php?id=<?php echo $rowid; ?>';">修改</button>
                                    </div>
                                </div>
                                <!--end card-body-->
                            </div>
