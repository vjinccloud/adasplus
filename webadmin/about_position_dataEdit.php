...
$sql = "select n.rowid,n.photo,n.a_name,n.a_job,n.a_name_en,n.a_job_en,isenable from about_position_list n  ";
...
while ($stmt = $result->fetch(PDO::FETCH_ASSOC)) {
    ...
    $a_name = $stmt['a_name'];
    $a_job = $stmt['a_job'];
    $a_name_en = $stmt['a_name_en'];
    $a_job_en = $stmt['a_job_en'];
...
<body class="crm_body_bg">
                        ...
                        <div
                            ...
                            <div class="page_title_left">
                                <ol class="breadcrumb page_bradcam mb-0">
                                    ...
                                    <li class="breadcrumb-item active">關於我們-成員介紹-編輯</li>
                                </ol>
                            </div>
                        </div>
                    </div>
                                ...
                                <form
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-lg-6 mb-3">
                                                <div class="col-lg-12 mb_15">
                                                    ...
                                                    <input
                                                        ...
                                                        id="fileinput"
                                                        accept="image/*" />
                                                    <small class="form-text text-muted">建議尺寸：270 x 228px</small>
                                                </div>
                                            ...
                                            <div class="col-lg-6 mb-3">
                                                <div class="col-lg-12 mb_15">
                                                    <label class="form-label" for="a_name">姓名</label>
                                                    <input
                                                        type="text"
                                                        class="form-control"
                                                        name="a_name"
                                                ...
                                                <div class="col-lg-12 mb_15">
                                                    <label class="form-label" for="a_job">職位</label>
                                                    <input
                                                        type="text"
                                                        class="form-control"
                                                        name="a_job"
                                                ...
                                                <div class="col-lg-12 mb_15">
                                                    <label class="form-label" for="a_name_en">姓名en</label>
                                                    <input
                                                        type="text"
                                                        class="form-control"
                                                        name="a_name_en"
                                                ...
                                                <div class="col-lg-12 mb_15">
                                                    <label class="form-label" for="a_job_en">職位en</label>
                                                    <input
                                                        type="text"
                                                        class="form-control"
                                                        name="a_job_en"
                                                ...
                                                <div class="col-md-12 mb_15">
                                                    <label class="form-label" for="csId">是否啟用</label>
                                                    <div class="common_select">
                                                        <select class="nice_Select wide mb_5" name="csId" id="enable">
                                            ...
                                            <div class="devices_btn justify-content-end">
                                                <div class="">
                                                    ...
                                                    <input type="hidden" name="mwId" value="" />
                                                    <button
                                                        type="button"
                                                    ...
                                                    <button
                                                        type="button"
                                                        class="btn btn-secondary mb-3 cancelBtn"
    ...
    <link rel="stylesheet" href="ckeditor/skins/moonocolor/editor.css" />
    ...
    <script>
        ...
        async function saveData() {
            ...
            let oldimgsrc = "";
            const url = "about_position_post.php";
            ...
            form_data.append("a_job", $("#a_job").val());

            form_data.append("a_name_en", $("#a_name_en").val());

            form_data.append("a_job_en", $("#a_job_en").val());

            form_data.append("isenable", $("#enable").val());
        ...
        $(document).ready(function() {
            ...
            $("select").niceSelect();
            $("#a_name").val('<?php echo $a_name; ?>');
            $("#a_job").val('<?php echo $a_job; ?>');
            $("#a_name_en").val('<?php echo $a_name_en; ?>');
            $("#a_job_en").val('<?php echo $a_job_en; ?>');
            ...
            $("#myModal").on('hide.bs.modal', function() {
                if ($("#modaltext").text().includes("成功")) {
                    window.location.href = "../webadmin/about_position.php";
                }
            });
            ...
            var oldimgsrc = document.getElementById('oldimgsrc').value; //URL.createObjectURL('http://vkphp.test:3001/web_admin/upload/2024/08/1724300188.jpg');//document.getElementsByClassName('preview')[0]; 
            document.getElementsByClassName('preview')[0].src = oldimgsrc;


            // var imgobj = srcToFile(myobj, 'temp.jpg', 'image/jpeg');
