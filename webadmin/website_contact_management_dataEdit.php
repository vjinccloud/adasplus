...
$sql = "select  username,email,phone,messagecontent,processingrecords,storytheme,statussettings from contact_list where rowid=:id";
...
while ($stmt = $result->fetch(PDO::FETCH_ASSOC)) {
  ...
  $email = $stmt['email'];
  $phone = $stmt['phone'];
  $messagecontent = $stmt['messagecontent'];
  $processingrecords = $stmt['processingrecords'];
  $storytheme = $stmt['storytheme'];
  $statussettings = intval($stmt['statussettings']);
}
...
<body class="crm_body_bg">
  ...
  <nav class="sidebar">
    <div class="logo d-flex justify-content-between">
      <a class="large_logo" href="https://team.vjinc.biz/member/index.php"><img src="./img/logo.png" alt="" /></a>
      <a class="small_logo" href="https://team.vjinc.biz/member/index.php"><img src="./img/mini_logo.png" alt="" /></a>
              ...
              <div class="white_card_body">
                <div class="card-body">
                  <form
                    role="form"
                    name="dateEdit"
                    action="//team.vjinc.biz/member/website_product_classification/dataSave.html"
                    method="post"
                    ...
                    <div class="col-lg-6 mb_15">
                      ...
                      <textarea id="processingrecords" class="form-control"></textarea>
                    </div>
                    <div class="col-lg-6 mb_15">
                      <label class="form-label" for="statussettings">狀態設定</label>
                      <div class="common_select">
                        <select class="nice_Select wide mb_5" id="statussettings">
  ...
  <script type="text/javascript">
    ...
    async function saveData() {
      ...
      form_data.append('status', $('#statussettings').val());
      form_data.append('processingrecords', $('#processingrecords').val());
    ...
    $(function() {
      ...
      $("#myModal").on("hide.bs.modal", function() {
        if ($("#modaltext").text().includes("成功")) {
          ...
          window.location.href = 'website_contact_management.php';
        }
      });
      ...
      $('#processingrecords').val('<?php echo $processingrecords ?>');
      $('#statussettings').val(<?php echo $statussettings ?>);
